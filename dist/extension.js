...
const command_handler_1 = __webpack_require__(13);
const sidebar_provider_1 = __webpack_require__(14);
const content_provider_1 = __webpack_require__(21);
const uri_service_1 = __webpack_require__(19);
const settings_1 = __webpack_require__(22);
class IntegratorFactory {
    ...
    _createSidebar() {
        return new sidebar_provider_1.SidebarProvider(this._extensionContext.extensionUri, this._extensionContext, this._getSettings());
    }
    _getContentProvider() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const watch_project_service_1 = __webpack_require__(4);
const constant = __webpack_require__(11);
const property_check_1 = __webpack_require__(12);
class Integrator {
    constructor(params) {
    ...
    _projectFolderWatch() {
        ...
        const projectFolderWatch = new watch_project_service_1.WatchWorkingDirectory({ context: this._extensionContext, sidebar: this._sidebar, settings: this._settings });
...
const make_directory_file_1 = __webpack_require__(10);
class WatchWorkingDirectory {
    ...
    getFilesOnTabs() {
        ...
        for (let tabGroup of vscode.window.tabGroups.all) {
            const activeTab = (_a = tabGroup.activeTab) === null || _a === void 0 ? void 0 : _a.input;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (config_1.config.workingDirectory) {
                    ...
                    const $this = this;
                    let ingoreList = this.settings.getHistoryIgnoreList();
...
class CommandHandler {
    ...
    _addToHistoryIgnoreList(targetPath) {
        const $this = this;
        let historyIgnoreFile = path.join(config_1.config.localDirectory, '.historyIgnore');
        let cleanTargetPath = targetPath.replace(config_1.config.workingDirectory + '/', '');
        if (fs.existsSync(historyIgnoreFile)) {
...
const vscode = __webpack_require__(2);
const getNonce_1 = __webpack_require__(15);
const working_files_history_provider_1 = __webpack_require__(16);
const working_history_files_1 = __webpack_require__(17);
class SidebarProvider {
    constructor(_extensionUri, context, settings) {
    ...
    eventDataChange() {
        return __awaiter(this, void 0, void 0, function* () {
            const monthList = yield this._historyWorkData().getHistoryByMonth();
            if (this._view) {
            ...
            webviewView.webview.onDidReceiveMessage((data) => __awaiter(this, void 0, void 0, function* () {
                switch (data.type) {
                    ...
                    case "getHistoryOfMonth": {
                        const list = yield this._historyWorkData().getHistoryDatesByMonth(data.value);
                        // console.log(list);
                    ...
                    case "settingHistoryIgnoreRemoveItem": {
                        const doRemoveHistItem = yield this.settings.removeHistoryIgnoreItem(data.value);
...
class WorkingFilesHistoryTab {
    ...
    static kill() {
        var _a;
        (_a = WorkingFilesHistoryTab.currentPanel) === null || _a === void 0 ? void 0 : _a.dispose();
...
class WorkingHistoryFiles {
    ...
    getHistoryByMonth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fs.statSync(this.historyDirectoryFullpath).isDirectory()) {
                const allList = yield fs.readdirSync(this.historyDirectoryFullpath, { withFileTypes: true });
                allList.forEach((dir) => {
    ...
    getHistoryDatesByMonth(yearMonthNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            let list = [];
            if (fs.statSync(this.historyDirectoryFullpath).isDirectory()) {
                const allList = yield fs.readdirSync(this.historyDirectoryFullpath, { withFileTypes: true });
...
class DiffPresenter {
    ...
    takeDiff(uri1, uri2, date, exactPath) {
        return __awaiter(this, void 0, void 0, function* () {
...
const constant = __webpack_require__(11);
const path = __webpack_require__(6);
const querystring = __webpack_require__(20);
class UriService {
    constructor(params) {
...
class Settings {
    constructor(params) {
        ...
        this.historyIgnoreFile = path.join(config_1.config.localDirectory, '.historyIgnore');
    }
    getHistoryIgnoreList(withoutDefault) {
        let ingoreList = [];
    ...
    removeHistoryIgnoreItem(value) {
        return __awaiter(this, void 0, void 0, function* () {
            const ask = yield this._vscode.window.showInformationMessage(`Delete "${value}" from History Ignore?`, "Yes", "No");
            if (ask === "Yes") {
